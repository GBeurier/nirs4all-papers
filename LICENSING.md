# Licensing — nirs4all-papers

`nirs4all-papers` is part of the **nirs4all ecosystem** and is offered under a
...
for example, embedding `nirs4all-papers` in a **proprietary, closed-source product or SaaS**
...
`nirs4all-papers` relies on third-party open-source components. Their licenses are summarized
